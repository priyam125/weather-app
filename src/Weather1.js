           ...
           <div className='main w-full bg-cover rounded-2xl bg-no-repeat border-2 p-4 relative' style={{backgroundImage: 'url(/images/night.jpg)'}}>
                ...
                {loading == true ? 
                    ...
                    <div className='flex flex-col w-1/3 items-center justify-center'>
                        ...
                        <div className='flex text-white space-x-4 justify-between w-full px-32'>
                            <div className='flex'>
                        ...
                        <div className='text-2xl text-white'>{condition}</div>
                    </div>

                    <div className='flex flex-col items-center h-56 w-1/6 text-white'>
                    ...
                    <div className={`text-white h-1/2 w-1/6 flex flex-col items-center justify-center shadow-2xl border-2 rounded-xl mr-96 ${toggle ? 'block' : 'hidden'}`}>
                        ...
                        <div className='w-1/2 h-1/2 mb-2'><CircularProgressbar circleRatio={0.75} styles={buildStyles({
                            ...
                            strokeLinecap: "butt",
                            trailColor: "#eee"
                          })} value={windSpeed} maxValue={100} text={`${windSpeed}Km/ph`}/></div>
                          <div className='text-xl mb-4 '>Chill:   {chill}</div>
                    </div>

                    <div className={`text-white h-1/2 w-1/6 flex flex-col items-center justify-center shadow-xl border-2 rounded-xl mr-96 ${toggle ? 'block' : 'hidden'}`}>
